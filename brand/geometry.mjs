/**
 * The kui-calendar brand mark, as raw geometry.
 *
...
export const COLORS = {
  ...
  /** TODAY MARKER — "today" — the marker every calendar view is read relative to. */
  toneTwo: "#06b6d4",
...
export const WORDMARK = { lead: "kui", trail: " calendar" };
...
export const TAGLINE = "Multi-view scheduling for the web";
